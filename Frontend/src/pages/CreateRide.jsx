...
export default function CreateRide() {
    const descs = {
        ...
        desc3: "With CoRide we have made the entire experience of carpooling simple, so you can easily publish your ride and find other people to share your ride with on your way."
    };
    const headings = {
    ...
    const publishDescs = {
        desc1: "Sign up as a ride publisher and add a profile picture, a few government-issued documents, and your phone number for verification.",
        desc2: "Provide departure and arrival time, location and arrival point, the date of the ride, and a price.",
        desc3: "Before accepting a request, you can review a passenger's profile to select if you want to travel with them or not."
    };
    return (
        <div className="bg-neutral-100">
            ...
            <div className="flex flex-col px-1 py-2 pb-8 bg-green-100">
                <div className="text-3xl font-semibold text-center text-slate-800 py-10 lg:text-6xl">
                    <span>Create a ride and save on travel costs by sharing your ride with other people</span>
                </div>
            ...
            <div className='p-2'>
                <div className='text-4xl p-2 mb-3 font-semibold text-center'>
                    <span>Publish your ride with just a few clicks</span>
                </div>
...
function Para({ image, heading, desc }) {
    return (
        <div>
            <div className="text-4xl text-slate-600 lg:text-5xl"><InlineIcon icon={image} /></div>
...
function PublishRidePara({ image, heading, desc }) {
    return (
        <div className='flex items-center gap-4'>
            <div className="text-4xl text-slate-600 lg:text-6xl"><InlineIcon icon={image} /></div>
            <div>
